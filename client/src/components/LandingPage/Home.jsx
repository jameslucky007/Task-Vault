...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 z-0 pointer-events-none bg-gradient-to-b from-black via-zinc-950 to-black"
        aria-hidden="true"
      />
      ...
      />
      {/* Radial Glow Overlay */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-indigo-600/5 blur-[130px] rounded-full pointer-events-none z-0" />
      <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] bg-violet-600/3 blur-[100px] rounded-full pointer-events-none z-0" />
