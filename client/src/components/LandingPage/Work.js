    ...
    <div className="w-full bg-white py-16 md:py-24 px-6 border-b border-zinc-100">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((item, index) => (
          <div
            key={index}
            className="flex flex-col gap-4 p-6 rounded-2xl bg-zinc-50/50 border border-zinc-100 hover:border-zinc-200 hover:bg-zinc-50 hover:-translate-y-1 transition-all duration-300 group shadow-sm"
          >
            {/* Icon */}
